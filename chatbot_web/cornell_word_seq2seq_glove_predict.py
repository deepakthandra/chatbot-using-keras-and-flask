...
GLOVE_MODEL = "../chatbot_train/very_large_data/glove.6B/glove.6B." + str(GLOVE_EMBEDDING_SIZE) + "d.txt"
...
def download_glove():
    if not os.path.exists(GLOVE_MODEL):
        ...
        if not os.path.exists(glove_zip):
            ...
            urllib.urlretrieve(url='http://nlp.stanford.edu/data/glove.6B.zip', filename=glove_zip,
